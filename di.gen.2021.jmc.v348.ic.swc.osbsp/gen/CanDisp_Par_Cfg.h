...
#define CanDisp_Number_Of_Rx_Messages        37u /*ch0 and ch1 total*/
#define CanDisp_Number_Of_Rx_MBs             37u /*finally not used*/
#define CanDisp_Number_Of_Tx_MBs             13u /*finally not used*/
#define CanDisp_Number_Of_MBs                50u /*ch0 and ch1 total*/
#define CanDisp_Number_Of_Tx_Messages        13u /*ch0 and ch1 total*/
#define CanDisp_Number_Of_Tx_Messages_Ch0    6u /*ch0 tx total*/
#define CanDisp_Number_Of_Tx_Messages_Ch1    7u /*ch1 tx total*/
