...
#define Can_Ch0_Nm_Rx_Msg_NM_BaseId           30//MCAL HRH of NM
#define Can_Ch0_Nm_Tx_Msg_IC_NM_TMH           5//MCAL HTH of NM 
...
#define VNM_RINGMSG_TTYP      100   /* RING TYPICAL TIME = 100msec */
...
#define VNM_SLEEP_TIME        5000  /* SLEEP ALONE/STARTUP SLEEP DELAY = 5000msec */
#define VNM_SLEEP_TIME_L      5000  /* SLEEP ALONE   SLEEP DELAY = 5000msec */ /*tSleepRequestMin_L, requirement from JMC*/
#define VNM_TWBS_TIME         5000  /* WAIT BUS SLEEP TIME = 5000msec */ /*JMC NM specificaton V1.6*/
